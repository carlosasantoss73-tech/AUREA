...
/**
 * Deterministic in-memory implementation for tests/pilot composition.
 * Production deployments must provide a durable implementation with
 * server-side revocation and persistence; the runtime contract stays the same.
 */
